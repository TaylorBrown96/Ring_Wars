    ...
    public class SqliteDataAccess
    {
        ...
        public static Items GetItem(string itemID)
        {
            using (var con = new SQLiteConnection(LoadConnectionString()))
            {
                ...
                rdr.Read();
                item = new Items(rdr.GetInt32(0), rdr.GetString(1), rdr.GetInt32(2), Convert.ToBoolean(rdr.GetString(3)), Convert.ToBoolean(rdr.GetString(3)), rdr.GetString(4));
                rdr.Close();
        ...
        public static Treasures GetTreasure(string treasureID)
        {
            using (var con = new SQLiteConnection(LoadConnectionString()))
            {
                ...
                rdr.Read();
                treasure = new Treasures(rdr.GetInt32(0), rdr.GetString(1), rdr.GetInt32(2), Convert.ToBoolean(rdr.GetString(3)), rdr.GetString(3));
                rdr.Close();
